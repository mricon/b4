...
def _review_help_lines(has_agent: bool = False) -> List[str]:
    ...
    lines = [
        ...
        '  [bold]r[/bold]         Open $EDITOR for reply (inline comments parsed)\n',
...
TRACKING_HELP_LINES = [
    ...
    '  A             ✔ when attestation verified.  An attestation that\n',
    ...
    '  Subject       Series subject line.  A highlighted v3→v6 version\n',
    '                token means a newer revision is available (upgrade\n',
    '                via a); v6 is the newest revision seen.\n',
    '\n',
    '[bold]Navigation[/bold]\n',
...
PW_HELP_LINES = [
    ...
    '  [bold]s[/bold]         Set state (marked series, or current)\n',
